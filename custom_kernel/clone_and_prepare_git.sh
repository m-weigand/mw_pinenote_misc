...
wget -nc https://raw.githubusercontent.com/m-weigand/mw_pinenote_misc/main/rockchip_ebc/patches/rockchip_ebc_patches_mw_20220804.patch
...
git apply ../rockchip_ebc_patches_mw_20220804.patch
